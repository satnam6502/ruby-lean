...
This project request had uuid: 832c385c-de90-49fb-8499-f1355f678fd3
...
theorem twoSorterNat_sorts (input output : List.Vector Nat 2)
    (h : twoSorterNat input output) : IsSorted output := by
  unfold twoSorterNat at h
  obtain ⟨h_min, h_max⟩ := h
  unfold IsSorted
  intro i j hij
