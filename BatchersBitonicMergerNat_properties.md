Prove the theorem BATCHER_BITONIC_MERGER_NAT_correct that shows the cirucit BATCHER_BITONIC_MERGER_NAT implements Batcher's Bitonic merger.

Fill in all the `by sorry` proofs.
